...
OrgChart._defaultConfig = function(t) {
    ...
    if (!OrgChart.LAZY_LOADING || this.isVisible)
        if (OrgChart.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(), 0 != this.width() && 0 != this.height())) {
            ...
            this.manager.read(t, this.width(), this.height(), n, e, r, (function(n) {
                if (!a.notifierUI.show(n.notif))
                    if (!1 !== a.config.lazyLoading || !0 !== t || e === OrgChart.action.exporting) {
                        e != OrgChart.action.exporting && (a.nodes = n.nodes, a.visibleNodeIds = n.visibleNodeIds, a.roots = n.roots), a.editUI.fields = n.allFields;
                        var o = {
                            defs: ""
                        };
                        ...
                        for (var c = 0; c < n.visibleNodeIds.length; c++) {
                            var g = n.nodes[n.visibleNodeIds[c]],
                                p = a._get(g.id);
                            OrgChart.RENDER_LINKS_BEFORE_NODES && (l += a.ui.link(g, a, s, n.bordersByRootIdAndLevel, n.nodes, e)), l += a.ui.node(g, p, n.animations, a.config, void 0, void 0, void 0, e, s, a)
                        }
                        for (c = 0; c < n.visibleNodeIds.length; c++) {
                            g = n.nodes[n.visibleNodeIds[c]];
                            OrgChart.RENDER_LINKS_BEFORE_NODES || (l += a.ui.link(g, a, s, n.bordersByRootIdAndLevel, n.nodes, e)), l += a.ui.expandCollapseBtn(a, g, a._layoutConfigs, e, s)
                        }
                        o = {
                            content: l,
                            res: n
                        };
                        if (OrgChart.events.publish("render", [a, o]), l = o.content, n = o.res, l += a.ui.lonely(a.config), e !== OrgChart.action.exporting) {
                            e !== OrgChart.action.centerNode && e !== OrgChart.action.insert && e !== OrgChart.action.expand && e !== OrgChart.action.collapse && e !== OrgChart.action.update || (d = h), e === OrgChart.action.init && null != h && (d = h), a.response = n;
                            x = a.ui.svg(a.width(), a.height(), d, a.config, l);
                            if (a._initialized) {
                                var u = a.getSvg(),
                                    f = u.parentNode;
                                f.removeChild(u), f.insertAdjacentHTML("afterbegin", x), a._attachEventHandlers(), a.xScrollUI.addListener(a.getSvg()), a.yScrollUI.addListener(a.getSvg()), a.xScrollUI.setPosition(), a.yScrollUI.setPosition()
                            } else a.element.innerHTML = a.ui.css() + x + a.ui.menuButton(a.config), a._attachInitEventHandlers(), a._attachEventHandlers(), a.xScrollUI.create(a.width(), a.config.padding), a.xScrollUI.setPosition(), a.xScrollUI.addListener(a.getSvg()), a.yScrollUI.create(a.height(), a.config.padding), a.yScrollUI.setPosition(), a.yScrollUI.addListener(a.getSvg()), a.config.enableSearch && a.searchUI.init(a), a.toolbarUI.init(a, a.config.toolbar);
                            var m = !1,
                            ...
                            })), a._initialized || (a._initialized = !0, a.filterUI.update(), OrgChart.events.publish("init", [a])), !a._loaded && n && n.nodes && Object.keys(n.nodes).length && (a._loaded = !0)
                        } else {
                            var b = n.boundary,
                                O = b.maxX - b.minX,
                                v = b.maxY - b.minY,
    ...
    if (n.draggable) {
        ...
        var O = function(t, e) {
            ...
            x = function(e) {
                if (o.moveEnd(), g.classList && (g.classList.remove("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")), g.removeEventListener(r.move, v), g.removeEventListener(r.up, x), r.leave && g.removeEventListener(r.leave, x), s.id == d || null == d) return g.removeChild(u), o._gragStartedId = null, void(t._dragEventFired && OrgChart.events.publish("drop", [o.nodeCircleMenuUI, {
                    from: s.id,
                    menuItemName: a,
                    menuItem: n,
                    event: e
                ...
                if (d) {
                    ...
                    if (C.left || C.right || C.up || C.down) {
                        ...
                        s.moveStart(C, (function(t) {
                            c[4] = O + t.x, c[5] = v + t.y, d.x = x - t.xWithoutScale, d.y = y - t.yWithoutScale, r.x = _ - t.xWithoutScale, r.y = w - t.yWithoutScale, f.setAttribute("transform", "matrix(" + c.toString() + ")")
                        }))
                    } else {
                        ...
                        var L = (r.x - d.x) / u,
                            N = (r.y - d.y) / u;
                        if (c[4] = g + L, c[5] = p + N, !t._dragEventFired && (Math.abs(r.x - d.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - d.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === OrgChart.events.publish("drag", [s, k, e]) && b(), t._dragEventFired = !0;
    ...
    if (t) {
        if (t.hasAttribute("data-search-item-id")) {
            ...
            if (this.input.value != OrgChart.SEARCH_HELP_SYMBOL) 0 != OrgChart.events.publish("searchclick", [this.obj, e]) && this.obj.center(e);
    ...
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
        ...
        for (var O = l[a.id]; O;) {
            if (m.push(O.id), a.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && O)
                for (d = 0; d < O.childrenIds.length; d++) {
                    (R = l[O.childrenIds[d]]).collapsed = !0
                }
        ...
        if (a.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
            for (d = 0; d < O.childrenIds.length; d++) {
                (x = l[O.childrenIds[d]]).collapsed = !1;
                for (var v = 0; v < x.childrenIds.length; v++) {
                    l[x.childrenIds[v]].collapsed = !0
                }
            }
    ...
    var y = [],
        ...
        k = {},
        S = [];
    for (d = 0; d < s.length; d++) OrgChart.manager._iterate(s[d], s[d], l, 0, y, _, w, k, "", m, S, t);
    ...
    for (d = 0; d < S.length; d++) {
        ...
        for (v = 0; v < C.children.length; v++) {
            (R = C.children[v]).isAssistant ? I.push(R.id) : -1 != R.tags.indexOf("right-partner") ? (R.isPartner = 1, R.children = [], A.push(R.id)) : -1 != R.tags.indexOf("left-partner") ? (R.isPartner = 2, R.children = [], E.push(R.id)) : -1 == R.tags.indexOf("partner") || N % 2 ? -1 != R.tags.indexOf("partner") && N % 2 ? (R.isPartner = 2, R.children = [], E.push(R.id), N++) : R.parentPartner ? (L[R.parentPartner.id] || (L[R.parentPartner.id] = []), L[R.parentPartner.id].push(R.id)) : I.push(R.id) : (R.isPartner = 1, R.children = [], A.push(R.id), N++)
        }
        C.children = [];
        var P = [];
        for (v = 0; v < A.length; v++) {
            L[(R = l[A[v]]).id] ? C.children.push(R) : C.children.splice(0, 0, R);
            for (var F = 0; F < R.childrenIds.length; F++) P.push(R.childrenIds[F])
        }
        var H = [];
        for (v = 0; v < E.length; v++) {
            L[(R = l[E[v]]).id] ? C.children.push(R) : C.children.splice(0, 0, R);
            for (F = 0; F < R.childrenIds.length; F++) H.push(R.childrenIds[F])
        }
        for (v = 0; v < H.length; v++) {
            (R = l[H[v]]).collapsed || (R.parentPartner = R.parent, R.parent = C, R.isChildOfPartner = !0, C.children.push(R))
        }
        for (v = E.length - 1; v >= 0; v--)
            if (L[E[v]])
                for (f = 0; f < L[E[v]].length; f++) C.children.push(l[L[E[v]][f]]), M++, -1 == U.indexOf(E[v]) && U.push(E[v]);
        ...
        for (v = 0; v < A.length; v++)
            if (L[A[v]])
                for (f = 0; f < L[A[v]].length; f++) C.children.push(l[L[A[v]][f]]), T++, -1 == B.indexOf(A[v]) && B.push(A[v]);
        for (v = 0; v < P.length; v++) {
            (R = l[P[v]]).collapsed || (R.parentPartner = R.parent, R.parent = C, R.isChildOfPartner = !0, C.children.push(R))
        }
    ...
    for (d = 0; d < w.length; d++) {
        ...
        for (v = 0; v < C.subLevels; v++) {
            var j = new OrgChart.node(C.id + "_sub_level_index_" + v, C.pid, [], "subLevel");
            if (OrgChart.manager._initDinamicNode(j, C.lcn), b = C.parent)(ft = b.children.indexOf(C)) > -1 && (b.children.splice(ft, 1), b.children.splice(ft, 0, j)), j.children.push(C), j.parent = b, C.parent = j, l[j.id] = j
        }
    }
    for (var z in _) {
        (b = l[z]).hasAssistants = !0;
        ...
        for (v = b.children.length - 1; v >= 0; v--) {
            (R = b.children[v]).isAssistant ? (R.parent = null, b.children.splice(v, 1), Y.splice(0, 0, R.id)) : R.isPartner || (R.parent && k[R.parent.id] && j && R.parent.id != j.id && (Object.defineProperty(k, j.id, Object.getOwnPropertyDescriptor(k, R.parent.id)), delete k[R.parent.id]), R.parent = j, j.children.unshift(R), b.children.splice(v, 1))
        }
        if (Y.length % 2) {
            var X = l[Y[Y.length - 1]],
                q = new OrgChart.node(X.id + "_mirror", b.pid, [], "mirror");
        ...
        for (v = Y.length - 1; v >= 0; v--)
            if (v % 2 && v != Y.length - 1) {
                ...
                OrgChart.manager._initDinamicNode(V, b.lcn, !0), l[V.id] = V, Y.splice(v, 0, V.id), $++
            } else v % 2 && Y.splice(v, 0, j.id);
        ...
        if (w.length) {
            ...
            if (rt) {
                ...
                for (var z in k) {
                    ...
                    for (d = 0; d < it.length; d++) {
                        var ht = it[d];
                        (null === st || w.has(ht)) && (st = l[ht].parent.id, lt || OrgChart.isNEU(l[ht].subLevels) || (lt = l[ht].subLevels > 0)), at[st] || (at[st] = []), at[st].push(ht), lt && (ot[st] = z, nt[st] || (nt[st] = []), nt[st].push(ht))
                    }
                }
                for (var z in k = {}, nt)
                    if (nt[z].length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN) {
                        var dt = ot[z];
                        for (d = l[dt].children.length - 1; d >= 0; d--) {
                            R = l[dt].children[d];
                            nt[z].has(R.id) && l[dt].children.splice(d, 1)
                        }
                    } for (var z in at) at[z].length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN && (k[z] = at[z])
            }
        }
        for (var z in k) {
            for (var ct = b = l[z]; ct.isSplit;) ct = l[ct.pid];
            for (; ct.isSubLevel;) ct = l[ct.pid];
            if ((D = r[b.lcn ? b.lcn : "base"]).layout > 0 || tt) {
                et.pnode = b, et.layout = D.layout, et.childrenIds = k[z], et.lastChildrenPidIds = k, et.subLevels = 0, et.layouts = [], OrgChart.events.publish("node-layout", [t, et]), OrgChart.events.publish("layout", [et]), et.layouts.length || et.layouts.push({
                    layout: et.layout,
                ...
                for (var gt = 0; gt < et.layouts.length; gt++) {
                    ...
                    for (OrgChart.isNEU(pt.subLevels) && (pt.subLevels = 0), OrgChart.isNEU(pt.layout) && (pt.layout = D.layout), ct = b = l[z]; ct.isSplit;) ct = l[ct.pid];
                    for (; ct.isSubLevel;) ct = l[ct.pid];
                    var ut = b;
                    for (v = 0; v < pt.subLevels; v++) {
                        j = new OrgChart.node(gt + "_sublevel_layout_" + v, ut.id, [], "subLevel");
                        OrgChart.manager._initDinamicNode(j, ut.lcn), j.parent = ut, ut.children.push(j), l[j.id] = j, ut = j
                    }
                    if (pt.subLevels) {
                        for (v = 0; v < pt.childrenIds.length; v++) {
                            var ft;
                            R = l[pt.childrenIds[v]]; - 1 != (ft = b.children.indexOf(R)) && b.children.splice(ft, 1), R.parent = ut, ut.children.push(R)
                        }
                        b = ut
                    }
                    if (pt.layout == OrgChart.layout.mixed) {
                        ...
                        for (d = mt.length - 1; d >= 0; d--) {
                            b = (R = l[mt[d]]).parent, R.layout = OrgChart.layout.mixed;
                            for (v = b.children.length - 1; v >= 0; v--)
                                if (R.id == b.children[v].id) {
                                    b.children.splice(v, 1);
                                    break
                                } if (d > 0) {
                                var Ct = l[mt[d - 1]];
                                R.parent = Ct, R.layout = OrgChart.layout.mixed, Ct.children.push(R)
                            } else b.children.push(R)
                        }
                    } else if (pt.layout > 1) {
                        j = new OrgChart.node(gt + "_" + b.id + "_split_0", ct.id, [], "split");
                        OrgChart.manager._initDinamicNode(j, b.lcn), l[j.id] = j, j.layout = pt.layout;
                        var bt = [];
                        for (d = pt.childrenIds.length - 1; d >= 0; d--) {
                            for (R = l[pt.childrenIds[d]], v = 0; v < b.children.length; v++) b.children[v].id == R.id && b.children.splice(v, 1);
                            if (R.parent = null, R.layout = pt.layout, pt.layout != OrgChart.layout.treeRightOffset && pt.layout != OrgChart.layout.treeRight || bt.splice(0, 0, R.id), pt.layout > 2) {
                                var Ot = new OrgChart.node(gt + "_" + R.id + "_mirror", ct.id, [], "mirror");
                                OrgChart.manager._initDinamicNode(Ot, R.lcn), Ot.layout = pt.layout, l[Ot.id] = Ot, bt.splice(0, 0, Ot.id)
                            }
                            pt.layout != OrgChart.layout.treeRightOffset && pt.layout != OrgChart.layout.treeRight && bt.splice(0, 0, R.id)
                        }
    ...
    for (var E = 0; E < h.length; E++) OrgChart.manager._iterate2(h[E], g, i, s, d, c, m, p, r, b);
    return {
        animations: b,
        boundary: C,
        viewBox: s,
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        var x = "";
        t.lcn && (x = 'lcn="' + t.lcn + '"');
        var y = OrgChart.nodeOpenTag.replace("{lcn}", x).replace("{id}", t.id).replace("{class}", v).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", O.x).replace("{y}", O.y),
    ...
    link: function(t, e, r, i, a, n) {
        ...
        for (f = 0; f < t.children.length; f++) {
            ...
            if (m.isChildOfPartner) switch (l.orientation) {
                ...
                if ((x || m.layout > 1) && m.rightNeighbor && m.rightNeighbor.isSplit) switch (l.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                ...
                } else if ((y || m.layout > 1) && m.leftNeighbor && m.leftNeighbor.isSplit) switch (l.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                    ...
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        if (1 == m.isPartner) b = OrgChart.ui._linkLeftToRight(t, m, s, c);
                        else if (2 == m.isPartner) b = OrgChart.ui._linkRightToLeft(t, m, s, c);
                        else {
                    ...
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        if (1 == m.isPartner) b = OrgChart.ui._linkTopToBottom(t, m, s, c);
                        else if (2 == m.isPartner) b = OrgChart.ui._linkBottomToTop(t, m, s, c);
                        else {
                            v = 1 == m.layout ? void 0 : C.maxX - (C.maxX - p.minX) / 2;
    ...
    for (var r = "", i = 0; i < this.config.clinks.length; i++) {
        ...
        if (n && -1 != e.res.visibleNodeIds.indexOf(n.id) && (o && -1 != e.res.visibleNodeIds.indexOf(o.id))) {
            ...
            if (a.label) {
                var x = OrgChart.clinkLabelPosition(a, c, g, b);
                r += v.label.replace("{x}", x.x).replace("{y}", x.y).replace("{val}", a.label)
            }
            var y = "M" + c.x + "," + c.y + "C" + c.x + "," + c.y + " " + b.x + "," + b.y + " " + g.x + "," + g.y;
            r += ("<g " + OrgChart.attr.c_link_from + '="{from}" ' + OrgChart.attr.c_link_to + '="{to}">').replace("{from}", n.id).replace("{to}", o.id) + v.link.replaceAll("{d}", y) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + y + '" />', r += OrgChart.grCloseTag
        }
    ...
    function n(e, n, o) {
        ...
        if (e.sl == n.sl) switch (h = n, g.orientation) {
            ...
            for (; null == h;) {
                var b = !1,
                    ...
                    v = O.leftNeighbor,
                    x = O.rightNeighbor;
                if (O.id == n.id ? h = O : OrgChart._intersects(O, f, t.config) && (f = OrgChart._addPoint(O, s, t.config, f, d), b = !0), O.id != n.id) {
                    for (; v;) {
                        if (v.id == n.id) {
                            h = v;
                            break
                        }
                        OrgChart._intersects(v, f, t.config) && (f = OrgChart._addPoint(v, s, t.config, f, d), b = !0), v = v.leftNeighbor
                    }
                    for (; x;) {
                        if (x.id == n.id) {
                            h = x;
                        ...
                        OrgChart._intersects(x, f, t.config) && (f = OrgChart._addPoint(x, s, t.config, f, d), b = !0), x = x.rightNeighbor
                    }
                }
                if (!b) {
        ...
        var U = e.id,
            P = n.id;
        o && (U = n.id, P = e.id), r += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", P) + p.link.replaceAll("{d}", N) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + N + '" />', r += OrgChart.grCloseTag
    }
    ...
    if (this.instance.config.filterBy) {
        ...
        var c = "";
        for (var l in this.filterBy) c += `<div data-filter-field="${l}">${l}</div>`;
        d.innerHTML = `<div>${c}</div>`, d.addEventListener("click", (function(t) {
                ...
                if (!o) {
                    ...
                    for (var s in h.filterBy[e]) {
                        var d = h.filterBy[e][s],
                            c = d.text;
                        null == c && (c = s), l += `<div>\n                        <input  type="checkbox" id="${s}" name="${s}" ${d.checked?"checked":""}>\n                        <label for="${s}">${c}</label>\n                    </div>`
                    ...
                    for (i = 0; i < g.length; i++) g[i].addEventListener("change", (function(t) {
                        ...
                        if (e) {
                            ...
                            } else if (null != h.filterBy[r][this.name] && (h.filterBy[r][this.name].checked = this.checked), this.checked)
                                for (var o = h.instance.config.nodes, l = 0; l < o.length; l++)
                                    if (o[l][r] == this.name)
                                        for (var s = o[l]; s;)
                                            if (OrgChart.isNEU(s.stpid)) s = OrgChart.isNEU(s.pid) ? null : h.instance._get(s.pid);
                                            else if ((s = h.instance._get(s.stpid))[r]) {
                                var d = t.target.parentNode.parentNode.querySelector('[name="' + s[r] + '"]');
                                d ? (d.checked = this.checked, h.filterBy[r][s[r]].checked = this.checked) : console.error('Cannot find element with selector: [name="' + s[r] + '"]')
                            }
                            h.instance.draw()
                        }
                    }))

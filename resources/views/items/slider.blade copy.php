...
<div class="place-content-center bg-red-600 w-full">
    <div x-data='{
      currentIndex: 1,
    ...
    }' class="relative mx-auto w-full overflow-hidden rounded-md bg-gray-100 ">
        ...
        <div class="relative h-96 w-full">
            <template x-for="(image, index) in images">
                <div x-show="currentIndex == index + 1" 
                  ...
                  >
                    <img :src=`storage/${image}` alt="image" class="rounded-sm" style="object-fit: contain" />
                </div>
            </template>
        </div>
    </div>

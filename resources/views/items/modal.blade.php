<div x-data="{ modelOpen: false }" class="absolute top-5 right-5">
    ...
    <div x-show="modelOpen" class="fixed left-10 right-10 inset-y-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
            ...
            >
                ...
                @include('items.slider', ['img_list' => $images])
            </div>
        </div>
    </div>
</div>